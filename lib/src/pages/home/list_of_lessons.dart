...
import 'package:a2_tutorial/src/pages/sura_test/new_tests/benchmark_query_speed.dart';
import 'package:a2_tutorial/src/pages/sura_test/new_tests/call_api.dart';
import 'package:a2_tutorial/src/pages/sura_test/new_tests/infinite_list.dart';
import 'package:a2_tutorial/src/pages/sura_test/new_tests/infinite_scroll_inside_tab.dart';
  ...
  LessonModel(
      ...
      page: SuraTest(
        ...
        lessons: [
          ...
          SubLessonModel(
              title: "benchmark query test", pages: BenchmarkQuerySpeed()),
          SubLessonModel(title: "infinite list", pages: InfiniteList()),
          SubLessonModel(
              title: "infinite list inside tab",
              pages: InfiniteScrollInsideTab())
